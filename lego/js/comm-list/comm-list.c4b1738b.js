...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _rcLegoCommList = __webpack_require__(237);

	    var _rcLegoCommList2 = _interopRequireDefault(_rcLegoCommList);
	    ...
	    _reactDom2['default'].render(_react2['default'].createElement(_rcLegoCommList2['default'], { itemAjaxConfig: itemAjaxConfig,
	      itemSuccessDataConfig: itemSuccessDataConfig, itemDataConfig: itemDataConfig }), (0, _jquery2['default'])('#commList')[0]);
	      ...
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/Users/yunyi/nodespace/lego/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot not apply hot update to " + "comm-list.js" + ": " + err.message);
	            }
	          });
	        }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/yunyi/nodespace/lego/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "comm-list.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMServer = __webpack_require__(226);
	var ReactIsomorphic = __webpack_require__(230);

	var assign = __webpack_require__(117);
	var deprecated = __webpack_require__(235);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEmptyComponentRegistry = __webpack_require__(122);
	var ReactInstanceHandles = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceMap = __webpack_require__(125);
	var ReactPerf = __webpack_require__(96);
	var ReactPropTypeLocations = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var keyOf = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = __webpack_require__(201);
	var ReactElement = __webpack_require__(120);
	var ReactPropTypeLocations = __webpack_require__(143);
	var ReactPropTypeLocationNames = __webpack_require__(144);
	var ReactNoopUpdateQueue = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(123);
	var ReactMarkupChecksum = __webpack_require__(126);
	var ReactServerBatchingStrategy = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapObject = __webpack_require__(233);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseList = __webpack_require__(238);
	...
	var _text = __webpack_require__(251);
	  ...
	  render: function render() {
	    ...
	    this.state.itemList.map(function (item, i) {
	      ...
	      children.push(_react2['default'].createElement(
	        'div',
	        { className: 'row-flex', key: i },
	        _react2['default'].createElement(
	          'div',
	          { className: 'col-8' },
	          _react2['default'].createElement(_image2['default'], { uri: uri })
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'col-16' },
	          _react2['default'].createElement(_text2['default'], { textString: textString, numberOfLines: numberOfLines })
	        )
	      ));
	    }, this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilScrollTrigger = __webpack_require__(240);
	...
	var BaseList = {
	          ...
	          this.setState({ isLast: isLast, page: this.state.page + 1 }, function () {
	            ...
	            this.threadId = setTimeout((function () {
	              ...
	              if (this.state.page === 2 && !isLast) {
	                ...
	                //绑定Scroll的滚动事件
	                this.add({
	                  element: (0, _jquery2['default'])(loadingEle),
	                  distance: 100,
	                  onRouse: (function () {
	      ...
	      (function () {
	        ...
	        (0, _jquery2['default'])(window).on('scroll', function () {
	          var scrollTop = (0, _jquery2['default'])(this).scrollTop(),
	              windowHeight = (0, _jquery2['default'])(this).height();
	  ...
	  renderRoot: function renderRoot(newProps) {
	    ...
	    return _react2['default'].createElement(
	      ...
	      null,
	      newProps.children,
	      _react2['default'].createElement('i', { className: loadingClass, ref: 'loading' }),
	      _react2['default'].createElement(
	        'div',
	        { className: lastClass },
	        'is Last!'
	      ...
	      _react2['default'].createElement(
	        'a',
	        { className: goTop,
	          href: 'javascript:void(0);', onClick: this.handleGoTop },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollTrigger = {
	  ...
	  start: function start() {
	    ...
	    // 绑定滚动处理
	    (0, _jquery2['default'])(window).bind('scroll.scrollTrigger', function () {
	      _self._scroll();
	    });

	    // 绑定修改窗口宽度处理
	    (0, _jquery2['default'])(window).bind('resize.scrollTrigger', function () {
	      _self._scroll();
	    });
	  },
	  ...
	  stop: function stop() {
	    // 注销滚动处理
	    (0, _jquery2['default'])(window).unbind('scroll.scrollTrigger');

	    // 注销修改窗口宽度处理
	    (0, _jquery2['default'])(window).unbind('resize.scrollTrigger');
	  ...
	  add: function add(options) {
	    ...
	    (0, _jquery2['default'])(options.element).each(function () {
	  ...
	  remove: function remove(options) {
	    ...
	    var elementArray = (0, _jquery2['default'])(options.element);
	  ...
	  activateAll: function activateAll() {
	    ...
	    if (_jquery2['default'].isEmptyObject(this.state.registers)) {
	      return;
	    }
	  ...
	  _calculateArray: function _calculateArray(distance) {
	     ...
	     */
	    // 如果不是数组, 格式化为数组
	    if (!_jquery2['default'].isArray(distance)) {
	  ...
	  getScreenRect: function getScreenRect() {
	    ...
	    rect.right = scrollPos.left + (0, _jquery2['default'])(window).width();
	    rect.bottom = scrollPos.top + (0, _jquery2['default'])(window).height();
	  ...
	  getScrollPos: function getScrollPos() {
	    var viewport = (0, _jquery2['default'])(window);
	    var pos = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilLazyLoadImages = __webpack_require__(248);
	...
	var Image = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    if (this.isMounted()) {
	      ...
	      this.lazyloadImagesInit({
	        element: (0, _jquery2['default'])(legoImage).find('img[data-src]'),
	        distance: 10
	      });
	    }
	  },
	  ...
	  render: function render() {
	    return this.props.uri !== '' ? _react2['default'].createElement(
	      'div',
	      { className: 'lego-image', ref: 'legoImage' },
	      _react2['default'].createElement('img', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ScrollTrigger = __webpack_require__(240);
	  ...
	  lazyloadImagesInit: function lazyloadImagesInit(options) {
	    ...
	    this.add({
	      ...
	      onRouse: function onRouse() {
	        var $currentEle = (0, _jquery2['default'])(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Text = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return typeof this.props.numberOfLines === 'undefined' || this.props.numberOfLines > 0 ? _react2['default'].createElement(
	      'div',
	      { className: textClass, onClick: this.handleClick },
